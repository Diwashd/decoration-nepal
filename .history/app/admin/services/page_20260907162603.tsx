...
export default function AdminServicesPage() {
  ...
  const openEdit = (service: typeof defaultServices[0]) => {
    ...
    setForm({ name: service.name, category: service.category, description: service.description, price: service.price, icon: service.icon, featured: service.featured, image: service.image || '' });
    setShowModal(true);
  };
