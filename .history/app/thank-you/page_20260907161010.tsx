...
export default function ThankYouPage({ searchParams }: { searchParams: { eventId?: string; whatsapp?: string } }) {
  const eventId = searchParams.eventId;
  const whatsappMessage = searchParams.whatsapp || getPlannerCompletedWhatsAppMessage({ eventId });
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center space-x-2 bg-primary text-surface px-6 py-3 rounded-sm hover:bg-primary/90 transition font-semibold text-sm tracking-wide"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center space-x-2 border border-primary text-primary px-6 py-3 rounded-sm hover:bg-primary/10 transition font-semibold text-sm tracking-wide"
              >
