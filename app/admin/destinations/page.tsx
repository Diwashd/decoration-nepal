          ...
          <div key={dest.id} className={`bg-surface-container border border-outline-variant rounded-xl overflow-hidden transition-all hover:border-primary/30 ${!dest.active ? 'opacity-60' : ''}`}>
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => openEdit(dest)} className="flex items-center gap-1 px-3 py-1.5 bg-surface-container-high rounded-lg text-sm text-on-surface hover:text-cream-contrast hover:bg-surface-container-highest transition-all cursor-pointer">
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={() => setShowModal(false)}>
          <div className="bg-surface-container border border-outline-variant rounded-2xl max-w-lg w-full p-6 space-y-4 max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button onClick={saveDestination} disabled={!form.name || !form.location || isSaving} className="px-4 py-2 bg-primary text-on-primary rounded-xl font-semibold hover:bg-primary/90 hover:scale-105 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100">
